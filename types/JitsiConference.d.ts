...
declare class JitsiConference {
    ...
    _e2eEncryption: E2EEncryption | undefined;
    ...
    connection: any;
    xmpp: any;
    codecSelection: CodecSelection | undefined;
    _statsCurrentId: any;
    room: any;
    ...
    e2eping: E2ePing | null | undefined;
    rtc: RTC | undefined;
    receiveVideoController: ReceiveVideoController | undefined;
    sendVideoController: SendVideoController | undefined;
    participantConnectionStatus: ParticipantConnectionStatusHandler | null | undefined;
    statistics: Statistics | undefined;
    _audioAnalyser: VADAudioAnalyser | undefined;
    _noAudioSignalDetection: NoAudioSignalDetection | undefined;
    /**
     * Emits {@link JitsiConferenceEvents.JVB121_STATUS}.
     * @type {Jvb121EventGenerator}
     */
    jvb121Status: Jvb121EventGenerator | undefined;
    p2pDominantSpeakerDetection: P2PDominantSpeakerDetection | undefined;
    /**
     ...
     * @returns {Promise}
     */
    getExternalAuthUrl(urlForPopup?: boolean | undefined): Promise<any>;
    /**
     * Returns the local tracks of the given media type, or all local tracks if no
     * specific type is given.
     * @param {MediaType} [mediaType] Optional media type (audio or video).
     */
    getLocalTracks(mediaType?: typeof MediaType | undefined): any[];
    /**
     ...
     * @returns {Object|null}
     */
    getPerformanceStats(): Object | null;
    /**
     ...
     */
    startRecording(options: Object): Promise<any>;
    /**
     ...
     */
    setStartMutedPolicy(policy: Object): void;
    /**
     * Returns current start muted policy
     * @returns {Object} with 2 properties - audio and video.
     */
    getStartMutedPolicy(): Object;
    /**
    ...
    restartInProgress: boolean | undefined;
    private _onIceConnectionFailed;
    _delayedIceFailed: IceFailedHandling | undefined;
     ...
     * }
     */
    setReceiverConstraints(videoConstraints: Object): void;
    /**

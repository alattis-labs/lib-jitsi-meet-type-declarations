...
declare class JitsiMediaDevices {
     ...
     */
    _handlePermissionsChange(permissions: Object): void;
    /**
     ...
     */
    isDeviceChangeAvailable(deviceType?: string | undefined): boolean;
    /**
     ...
     */
    isDevicePermissionGranted(type?: "audio" | "video" | undefined): Promise<boolean>;
    /**

...
export default class JingleSession extends Listenable {
     ...
     */
    constructor(sid: string, localJid: string, remoteJid: string, connection: any, mediaConstraints: Object, iceConfig: Object, isInitiator: boolean);
    sid: string;
    localJid: string;
    remoteJid: string;
    connection: any;
    ...
    terminate(success: any, failure: any, options: {
        ...
        requestRestart?: boolean | undefined;
        sendSessionTerminate?: boolean | undefined;
    }): void;
    /**

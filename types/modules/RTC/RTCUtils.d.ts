...
declare class RTCUtils extends Listenable {
    ...
    attachMediaStream: Function | undefined;
    getStreamID: (({ id }: {
        id: any;
    }) => any) | undefined;
    getTrackID: (({ id }: {
     ...
     * @returns {Promise}
     */
    _getUserMedia(umDevices: any, constraints?: Object, timeout?: number): Promise<any>;
    /**
     ...
     */
    _getMissingTracks(requestedDevices: string[] | undefined, stream: MediaStream): string[];
    /**
